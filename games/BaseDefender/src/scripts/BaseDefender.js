...
Runner.imgLoadHandler = function(e)
{
	...
	{		
	    ...
	    main.style.backgroundImage = "url(" + ImageManager[0].src + ")";
	    main.style.position = "absolute";
	    main.style.left = (window.innerWidth - 1200 >> 1) + "px";
	    main.style.top = (window.innerHeight - 580 >> 1) + "px";
...
Runner.createGame = function()
{
	...
	var offset = Runner.getElementOffset(canvas);
	offsetX = offset.left;
	offsetY = offset.top;
...
{	
	...
	{		
	    ...
	    var obj = stage.getObjectUnderPoint(e.mouseX-offsetX, e.mouseY-offsetY, true);
...
Runner.getElementOffset = function (elem) {
