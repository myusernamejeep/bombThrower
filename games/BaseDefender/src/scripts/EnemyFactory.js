(function(scope) {
	...
	{	
		this._roundInterval = setInterval( Atari.proxy(this.create, this), this.createTime*1000);
	}
	...
	EnemyFactory.prototype.resume = function()
	{
		...
		{
			this._createInterval = setInterval( Atari.proxy(this._countDown, this), 1000);
		}else
		{
			this.run();
		}
	...
	scope.EnemyFactory = EnemyFactory;
